                    ...
                    <div
                        ...
                        <fieldset className="fieldset p-5">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <button type="submit" className="btn btn-soft mt-10 w-full mb-8 hover:shadow-md shadow-green-200"
                                    disabled={pending}
                                >
                                    Log in
                                </button>
                            ...
                            {!!error && (
                                <div className="bg-warning/30 p-5 rounded-md flex items-center text-sm text-destructive gap-2">
